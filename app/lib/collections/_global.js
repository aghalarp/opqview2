...
// Note the unusual file location of this file. Ideally, we'd like to place this directly in /lib, but we have to
// place it here because of the way Meteor does file loading (deeper paths are loaded first).
// Once ES6 modules are implemented in Meteor, we can use imports/exports and avoid this problem entirely.
Global = {};
Global.Schemas = {};
Global.Enums = {};
Global.Utils = {};
